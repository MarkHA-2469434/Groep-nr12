...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->playerBankrupt(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Player::*)(int )>(_a, &Player::moneyChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(int )>(_a, &Player::positionChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)()>(_a, &Player::playerBankrupt, 2))
            return;
    }
}
